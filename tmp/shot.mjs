...
const shots = [
	...
	{ name: 'node-detail', path: '/nodes/hkg1-edge', auth: true },
	{ name: 'node-detail-dark', path: '/nodes/hkg1-edge', auth: true, theme: 'dark' },
	{ name: 'node-status', path: '/nodes/hkg1-edge', auth: true, clickTab: 1, viewportOnly: true },
